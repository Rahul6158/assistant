...
if uploaded_file is not None:
    ...
    with left_column:
        ...
        if plot_type == 'Line Plot':
            ...
            ax_line.plot(df[x_column].head(10), df[y_column].head(10))
            ...
            ax_scatter.scatter(df[x_column].head(10), df[y_column].head(10), color='g')
            ...
            ax_hist.hist(df[column].head(10), bins=10, color='c', alpha=0.75)
            ...
            ax_bar.bar(df[x_column].head(10), df[y_column].head(10), color='m')
            ...
            ax_3d.scatter(df[x_column].head(10), df[y_column].head(10), df[z_column].head(10), c='r', marker='o')
